        ...
        <div class="col">
           <form>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                    <input id="txt_freundVorname" value="Tom" name="txt_freundVorname" placeholder="Vorname" class="form-control input-md" required="" type="text">
                    </div>
                  </div><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                    <input id="txt_freundNachname" value="Berger" name="txt_freundNachname" placeholder="Nachname" class="form-control input-md" required="" type="text">
                    </div>
                  </div><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                    <input id="txt_freundWohnort" value="Stuttgart" name="txt_freundWohnort" placeholder="Ort" class="form-control input-md" required="" type="text">
                    </div>
                  </div><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="checkbox">
                      <label for="checkboxes_studiengang-0">
                        <input name="checkboxes_studiengang" checked id="checkboxes_studiengang-0" value="Wirtschaftsinformatik" type="checkbox">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4"> 
                      <label class="radio-inline" for="radios_semester-0">
                        <input name="radios_semester" id="radios_semester-0" value="1" checked="checked" type="radio">
                        1
                      </label> 
